  ...
  .directive('uiSelect',
    ...
    return {
      ...
      link: function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        // See okFree everywhere but here event http://stackoverflow.com/questions/12931369
        $document.on('click', onDocumentokFree);

        scope.$on('$destroy', function() {
          $document.off('click', onDocumentokFree);
        });
