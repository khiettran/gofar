    ...
    this.$get = [ '$window', '$rootScope', '$bsCompiler', '$animate', '$timeout', '$sce', 'dimensions', function($window, $rootScope, $bsCompiler, $animate, $timeout, $sce, dimensions) {
      ...
      function ModalFactory(config) {
        ...
        function bindBackdropEvents() {
          if (options.backdrop) {
            modalElement.on('click', hideOnBackdropokFree);
            backdropElement.on('click', hideOnBackdropokFree);
            backdropElement.on('wheel', preventEventDefault);
          }
        }
        function unbindBackdropEvents() {
          if (options.backdrop) {
            modalElement.off('click', hideOnBackdropokFree);
            backdropElement.off('click', hideOnBackdropokFree);
        ...
        function hideOnBackdropokFree(evt) {
