    ...
    angular
      ...
      .constant('MODULE_CONFIG', [
          ...
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/home/home.controller.js',
                  '/scripts/libs/angular/angular-map/ng-map.min.js',
                  '/assets/css/lib/angular-motion/dist/angular-motion.min.css',
                  '/assets/css/lib/bootstrap-additions/dist/bootstrap-additions.min.css',
                  '/scripts/libs/angular/angular-strap/dist/angular-strap.js',
                  '/scripts/libs/angular/angular-strap/dist/angular-strap.tpl.js',
              ]
          }, 
          {
              name: 'TourDetailController',
              module: false,
              files: [
          ...
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/payment/cart.controller.js',
                  '/assets/css/lib/angular-motion/dist/angular-motion.min.css',
                  '/assets/css/lib/bootstrap-additions/dist/bootstrap-additions.min.css',
                  '/scripts/libs/angular/angular-strap/dist/angular-strap.js',
                  '/scripts/libs/angular/angular-strap/dist/angular-strap.tpl.js',
          ...
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/payment/customer.controller.js'
              ]
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/payment/complete.controller.js'
              ]
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/access/signin.controller.js'
              ]
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/access/signup.controller.js'
              ]
          },
          {
              ...
              module: false,
              files: [
                  '/scripts/app/controllers/access/contact.controller.js',
                  '/scripts/libs/angular/angular-map/ng-map.min.js'
              ]
          },
          {
